...
plot.exp.line <- plot.pop +
  ...
  annotate("text", x = 1.5, y = 32, label = "Exponential; r = 0.04", 
           color = "#E69F00", size=8)+
  annotate( "text", x=1.5, y=28, label= "Weight = 15%", 
            color="#E69F00", size=8)
...
plot.log.line <- plot.pop +
  ...
  annotate( "text", x=2.5, y=32, label= "Logistic; r= 1.44, K = 21", 
            color="#56B4E9", size=8)+
  annotate( "text", x=1.5, y=28, label= "Weight = 85%", 
            color="#56B4E9", size=8)
plot.log.line
