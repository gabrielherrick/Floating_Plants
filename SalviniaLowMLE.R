...
plot.exp.line <- plot.pop +
  ...
  annotate("text", x = 1.5, y = 42, label = "Exponential; r = 0.24", 
           color = "#E69F00", size=8)+
  annotate( "text", x=1.5, y=38, label= "Weight = 76%", 
            color="#E69F00", size=8)
plot.exp.line

png("Salvinia_Low_ExpLine.png")
# or tiff("plot.tiff")
print(plot.exp.line)
dev.off()
...
plot.log.line <- plot.pop +
  ...
  annotate( "text", x=2.5, y=42, label= "Logistic; r= 0.31, K = 112", 
            color="#56B4E9", size=8)+
  annotate( "text", x=2.5, y=38, label= "Weight = 24%", 
            color="#56B4E9", size=8)
plot.log.line

png("Salvinia_Low_LogLine.png")
# or tiff("plot.tiff")
print(plot.log.line)
dev.off()
